...
@bot.event
async def on_ready():
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name="join OZ !")) # You can delete this line or change ducchub to your server name, its just a custom status
    print("""
